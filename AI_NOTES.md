...
- **Construção da Infraestrutura Docker:** Geração das etapas de build (*multi-stage builds*) e orquestração dos 4 containers no `docker-compose.yml` com *healthchecks* do PostgreSQL.
